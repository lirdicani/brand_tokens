    ...
    render () {
        return (
            <div className='privacy-policy-page'>
                <div className='privacy-policy-clip-effect-page'></div>
                <div className='privacy-policy-body'>
                    <div className='privacy-policy-page-title1'>Privacy Policy</div>
                    <div className='privacy-policy-page-title2'>Last updated: January 10, 2020</div>
